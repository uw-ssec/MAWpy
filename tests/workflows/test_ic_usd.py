...
from mawpy.workflows.ic_usd import ic_usd


def test_ic_usd(tmp_path):
    ...
    actual_output_df = ic_usd(args.input_file, args.output_file, args.spatial_constraint,
    ...
    expected_output_df = pd.read_csv(os.path.dirname(__file__)
                                     + '/../resources/ic_usd_output_for_test_input.csv')
